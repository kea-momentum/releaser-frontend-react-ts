...
import { uploadImage } from "@/util/functions/uploadImg";
...
export default function ProjectModal({onClose, type, onSave, project}: ProjectModalProps) {
    ...
    const validateInputField = (callback: (titleAlert: string, teamAlert: string, contentAlert: string) => void) => {
        let titleAlert = "";
        let teamAlert = "";
        let contentAlert = "";
    ...
    return (
        <S.Wrapper>
                    ...
                    <S.ImgButtonWrapper>
                        <S.ImgButtonSection>
                            <label htmlFor="uploadImage">
                                <Pencil size={16} color="#999696" style={{cursor: "pointer"}} />
                                <input
                                    id="uploadImage"
                                    type="file"
                                    accept="image/*"
            ...
            <S.BtnWrapper>
                ...
                <S.BtnContent onClick={handleSave} style={{backgroundColor: "#FFCE70", color: "#676767"}}>저장</S.BtnContent>
            </S.BtnWrapper>
        </S.Wrapper>
    );
}